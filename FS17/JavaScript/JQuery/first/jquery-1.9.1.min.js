...
(function (e, t) {
    ...
    b.fn.load = function (e, n, r) {
        ...
        ajaxSettings: {
            ...
            processData: !0,
            async: !0,
            contentType: "application/x-www-order_form-urlencoded; charset=UTF-8",
            accepts: {
                "*": Dn,
                text: "text/plain",
                html: "text/html",
    ...
    b.ajaxSetup({
        ...
        var o, a, s,
            u = n.jsonp !== !1 && (Bn.test(n.url) ? "url" : "string" == typeof n.data && !(n.contentType || "").indexOf("application/x-www-order_form-urlencoded") && Bn.test(n.data) && "data");
